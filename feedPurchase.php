                    ...
                    if(isset($_GET["feedpurchupdate"])){
                        ...
                        ?>
                            <form action="includes/action.php" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="feed" value="<?php echo $row["feedname"]; ?>" required>
                                </div>
                                <div class="input-group">
                        ...
                        ?>
                            <form action="includes/action.php" method="post">
                                <div class="input-group">
                                    <label for="">Date</label>
                                    <input type="date" name="Date" value="<?php echo mysqlDate(); ?>" required>
                                </div>
                                <div class="input-group">
                                    <label for="">Feed</label>
                                    <input type="text" name="feed" value="" required>
                                </div>
                                <div class="input-group">
                                    <label for="">Quantity</label>
