          ...
          <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                ...
                <p class="category"> Sreach from date <input class="form-control max-width200" id="search" type="date" onclick="this.showPicker()" name="" placeholder="Enter search"></p>
              </div>
              <div class="card-body">
...
<script type="text/javascript">
  ...
  function showTransactions(){
    ...
    xml.open("GET","extenstions/prodext.php?val="+val);
    xml.send();
  }
